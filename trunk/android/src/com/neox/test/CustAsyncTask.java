...
public abstract class CustAsyncTask<Params, Progress, Result> {
	...
	public CustAsyncTask() {
		...
		mFuture = new FutureTask<Result>(mWorker) {
			...
			protected void done() {
				...
				try {
					...
					message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
							new AsyncTaskResult<Result>(CustAsyncTask.this, (Result[]) null));
				...
				message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
						new AsyncTaskResult<Result>(CustAsyncTask.this, result));
				message.sendToTarget();
			}
			...
			public boolean cancel(final boolean mayInterruptIfRunning) {
				...
				LogUtil.e(LOG_TAG, "mayInterruptIfRunning:" + mayInterruptIfRunning + "   retval:" + retval + "  WorkQueueSize:" + getWorkQueueSize());
				Message message;
				message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
						new AsyncTaskResult<Result>(CustAsyncTask.this, (Result[]) null));
				sHandler.sendMessageDelayed(message, 1000);
				return retval;
			}
		};
	}
	...
	public static final int getWorkQueueSize() {
	 ...
	 */
	public final CustAsyncTask<Params, Progress, Result> execute(final Params... params) {
	...
	private static class AsyncTaskResult<Data> {
		...
		final CustAsyncTask mTask;
		final Data[] mData;

		@SuppressWarnings("rawtypes")
		AsyncTaskResult(final CustAsyncTask task, final Data... data) {
			mTask = task;
			mData = data;
		}
	}
	...
	public static int getCorePoolSize() {
		return sExecutor.getCorePoolSize();
	}
}
